...
@Composable
fun AddImageMethodBottomSheetContent(onTakePicture: () -> Unit, onPickGallery: () -> Unit) {
    Column(
        ...
        Text(text = "Choose a method to add a new picture", style = MaterialTheme.typography.body1, textAlign = TextAlign.Center)

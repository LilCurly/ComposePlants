    ...
    LoadingScreenComposable(isLoading = state.isLoading) {
        Column(modifier = Modifier
            ...
            Column(modifier = Modifier.fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally) {
                Text(text = "Welcome", style = MaterialTheme.typography.h1, color = MaterialTheme.colors.primary)
                Spacer(modifier = Modifier.height(6.dp))
                Text(text = "To continue please define a username.", style = MaterialTheme.typography.body1, color = Grey)
            }
